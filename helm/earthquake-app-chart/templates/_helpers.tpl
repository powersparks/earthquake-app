...
*/}}
{{- define "earthquake-app-chart.name" -}}
...
*/}}
{{- define "earthquake-app-chart.chart" -}}
...
*/}}
{{- define "earthquake-app-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "earthquake-app-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
